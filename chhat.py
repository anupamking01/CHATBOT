...
def wishMe():
    ...
    speak.Speak("I am Jarvis Sir. Please tell me how may I help you")
    ...
    # if 1:
        ...
        if 'Wikipedia' in query:
            ...
            try:
                ...
                content = takeCommand()
                to = "champgamy@gmail.com"
                sendEmail(to, content)
                speak.Speak("Email has been sent!")
            except Exception as e:
                print(e)
                speak.Speak("Sorry my friend Anupam. I am not able to send this email")
